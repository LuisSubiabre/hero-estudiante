...
* remove outdated features from the login information section ([efd27a0](https://github.com/LuisSubiabre/hero-estudiante/commit/efd27a042caa5d8315b1cdf534ce681e4acc6fdf))
...
* actualizar el formulario de inicio de sesión para mejorar la usabilidad, cambiando la colocación de las etiquetas y añadiendo placeholders en los campos de correo electrónico y contraseña ([fc6fe9c](https://github.com/LuisSubiabre/hero-estudiante/commit/fc6fe9c7b2ebe565fd73de2fb75874a7db613291))

### [5.0.3](https://github.com/LuisSubiabre/hero-estudiante/compare/v5.0.2...v5.0.3) (2025-09-05)


### Features

* añadir sección informativa en el formulario de inicio de sesión, destacando las funcionalidades de la plataforma para los estudiantes ([525658e](https://github.com/LuisSubiabre/hero-estudiante/commit/525658ed2a4fb14d59bfde0cd1cbdccedb914c44))
